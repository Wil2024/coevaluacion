...
equipos_estudiantes = {
    "Selecciona tu equipo":["Selecciona tu nombre"],
...
if modo == "Estudiante":
    ...
    if equipo_seleccionado:
        ...
        evaluador = st.selectbox("Selecciona tu nombre;", options=integrantes[1:])

        st.write("### Ahora, califica a cada compañero de tu equipo (incluyéndote):")
        notas = {}
